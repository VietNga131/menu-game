	...
	Mix_Chunk *gClick)
{
	if (HelpButton.IsInside(e, COMMON_BUTTON))
	{
		...
		case SDL_MOUSEBUTTONDOWN:
			...
			break;
		}//lí do nó ấn đc ở day còn ko hiện thì chịu
		//cái chỗ render dou
	}
	else
	{
...
void DrawPlayerScore(BaseObject gTextTexture,
	...
	const int& score)
{
//    gTextTexture.SetRect(TEXT_1_POSX, TEXT_1_POSY);
	...
	{
//	    gScoreTexture.SetRect(SCORE_POSX, SCORE_POSY);
...
{
//    gTextTexture.SetRect(TEXT_2_POSX, TEXT_2_POSY);
	...
	{
//	    gHighScoreTexture.SetRect(HIGH_SCORE_POSX, HIGH_SCORE_POSY);
